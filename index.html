...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Outfit:wght@300;500;700&display=swap" rel="stylesheet">
    <style>
...
<div class="header">
    <a href="https://t.me/aihindiagency" target="_blank" class="tg-btn">Join Telegram</a>
    <h1>X GEN AI</h1>
    <div class="tabs">
...
<div class="container">
    <div id="creatorTab">
        <div class="prompt-box">
            <textarea id="prompt" rows="3" placeholder="What do you want to create today?"></textarea>
            <div class="controls">
                <select id="ratio">
        ...
        <div class="result-area">
            ...
            <a href="#" id="dlBtn" class="download-btn" onclick="downloadCurrent()">Download HD</a>
        </div>
    </div>

    <div id="galleryTab">
        <div class="gallery-grid" id="galleryGrid"></div>
        <div id="emptyMsg" class="empty-msg">No images yet. Create something amazing!</div>
    </div>
</div>
